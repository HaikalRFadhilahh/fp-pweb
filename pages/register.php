            ...
            <div class="rounded-lg px-4 py-4 bg-white bg-opacity-50 backdrop-blur-sm lg:bg-opacity-0 lg:bg-transparent lg:backdrop-blur-none ">
                ...
                <form action="../aksi/aksi_register.php" method="POST" class="my-4 flex flex-col gap-4">
                    ...
                    <label for="password">
                        ...
                        <input type="text" id="password" name="password" class="py-2 px-3 w-full rounded-2xl outline-none ring-0 border-[1px] border-blue-500" minlength="3" required>
                    </label>
                    <label for="verifpassword">
                        <p class="font-light text-lg">Ulangi Password</p>
                        <input type="text" id="verifpassword" name="verifpassword" class="py-2 px-3 w-full rounded-2xl outline-none ring-0 border-[1px] border-blue-500" minlength="3" required>
                    </label>
